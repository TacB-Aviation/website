...
this.set("currentPreview",t),(0,s.schedule)("afterRender",(()=>{(0,_.applyLocalDates)(document.querySelectorAll(".preview .discourse-local-date"),this.siteSettings)}))}}static#r=(()=>dt7948.n(this.prototype,"_renderPreview",[(0,h.debounce)(g.INPUT_DELAY)]))()
...
formattedCurrentUserTimezone(t){return t.replace("_"," ").replace("Etc/","").replace("/",", ")}static#g=(()=>dt7948.n(this.prototype,"formattedCurrentUserTimezone",[(0,h.default)("currentUserTimezone")]))()
previewedFormats(t){return t.map((t=>({format:t,preview:moment().format(t)})))}static#_=(()=>dt7948.n(this.prototype,"previewedFormats",[(0,h.default)("formats")]))()
...
_generateDateMarkup(t,e,a,o){return(0,D.default)(t,e,a,o)}toggleModeBtnLabel(t){return t?"discourse_local_dates.create.form.simple_mode":"discourse_local_dates.create.form.advanced_mode"}static#T=(()=>dt7948.n(this.prototype,"toggleModeBtnLabel",[(0,h.default)("advancedMode")]))()
...
updateFormat(t,e){e?.preventDefault(),this.set("format",t)}static#D=(()=>dt7948.n(this.prototype,"updateFormat",[i.action]))()
selectedDate(t){return t?this.date:this.toDate}static#w=(()=>dt7948.n(this.prototype,"selectedDate",[(0,h.default)("fromSelected","toSelected")]))()
...
//# sourceMappingURL=discourse-local-dates-f1fde233.map